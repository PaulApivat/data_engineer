...
# PAYMENT_POST_PROCESSORS can either be a list, set, tuple or iterable...(tuples are immutable)
PAYMENT_POST_PROCESSORS = [
...
# PostProcessingFunction is either a list, set, tuple or iterable...
...
def main() -> None:
    ...
    handle_payment_post_processors(100, alice, PAYMENT_POST_PROCESSORS)
