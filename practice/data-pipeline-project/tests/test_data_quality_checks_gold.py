...
class TestEthEmissionsGoldValidation(unittest.TestCase):
    def test_validation(self):
        # Define the path to the schema file
        schema_path = "config/schema_definitions/eth_emissions_gold_schema.json"
